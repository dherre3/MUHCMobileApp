			...
			if(mode==='Online'){
				...
				for (var i = 0; i < keysDocuments.length; i++) {
	            	...
	            	if(app){
							...
							var targetPath='';
							if(platform==='Android'){
						    	targetPath = cordova.file.dataDirectory+'docMUHC'+documents[keysDocuments[i]].DocumentSerNum;
							}else if(platform==='iOS'){
								targetPath = cordova.file.documentsDirectory+ 'docMUHC'+documents[keysDocuments[i]].DocumentSerNum;
							}
